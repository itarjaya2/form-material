...
<html lang="en">
  <head>
    ...
    <title>Data Corrugated</title>
  </head>
  <body>
    <x-navbar/>
    <h1 class="text-center mb-5">Corrugated</h1>
    ...
    <div class="card shadow">
        ...
        <div>
            ...
            <a href="{{ route('corrugated.create') }}" class="btn btn-primary">
                Tambah Data
            </a>
        </div>
        </div>
...
<div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('corrugated.import') }}"
                  method="POST"
